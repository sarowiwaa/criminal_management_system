...
<html>
   <head>
      ...
      <script type="text/javascript">
         function submitBtn()
         {
             ...
             else if (document.forms["crimeInfo"]["complainantName"].value == "") {
    alert('Please fill out all the fields');
}
   ...
   <body>
      ...
      <div class="finaldiv">
         ...
         <!-- Form for criminal info submission -->
         <form id="crimeInfo" method="post" style="position:absolute;top:140px;background-image: url('police_logo_1.png'); background-repeat:no-repeat;margin-top: 50px; background-size: 90%; width: 50%;height:469px" enctype="multipart/form-data">
            <table >
               ...
               <tr>
                  <td>Section</td>
                  <td><input name="more" required></input></td>
               </tr>
               <tr><td><br></td></tr>
               <tr>
                  <td>Criminal's DOB</td>
               ...
               <tr><td><br></td></tr>
               <tr>
   <td>Complainant's Name</td>
   <td><input type="text" required name="complainantName"></td>
</tr>
<tr><td><br></td></tr>
...
<?php
// PHP code to handle form submission and data insertion
...
if(isset($_POST['submit'])){
    ...
    if (move_uploaded_file($tmpname, $folder)) {
        ...
        $q1 = "INSERT INTO `info`(`id`, `name`, `offname`, `complainantName`, `crime`, `dob`, `arrDate`, `crimeDate`, `sex`, `address`, `img`, `more`) 
       VALUES ('$id','$name','$offName','$complainantName','$crime','$dob','$arrDate','$crimeDate','$sex','$address','$folder','$more')";
